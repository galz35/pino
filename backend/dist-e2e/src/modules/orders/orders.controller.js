...
let OrdersController = class OrdersController {
    ...
    findAll(storeId, status, vendorId, fromDate, toDate) {
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Listar pedidos con filtros' }),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Obtener detalle de un pedido' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Actualizar status de un pedido' }),
    __param(0, (0, common_1.Param)('id')),
